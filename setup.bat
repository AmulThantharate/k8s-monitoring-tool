...
:: ================================================================
:: OPTION 1: QUICK LOCAL SETUP (OPTION A)
:: ================================================================
:OPTION_A
call :CHECK_PREREQS
...
:: ================================================================
:: OPTION 2: KUBERNETES SETUP (OPTION B)
:: ================================================================
:OPTION_B
call :CHECK_PREREQS
...
:: ================================================================
:: OPTION 4: START INFRASTRUCTURE ONLY
:: ================================================================
:START_INFRA
call :CHECK_PREREQS
echo.
...
:: ================================================================
:: OPTION 5: START BACKEND & FRONTEND SERVERS
:: ================================================================
:START_APP
echo.
...
:: ================================================================
:: OPTION 8: STOP ALL SERVICES & TEARDOWN
:: ================================================================
:STOP_ALL
echo.
echo ================================================================
...
echo.
set /p STOP_MINI="Do you also want to stop Minikube? (y/n): "
if /i "%STOP_MINI%"=="y" (
    where minikube >nul 2>&1
    if %errorlevel% equ 0 (
